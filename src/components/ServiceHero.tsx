import { CheckIcon, WhatsAppIcon, ServiceIcon } from "./Icons";
      ...
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        <Reveal>
          ...
          <div className="glass mt-6 mb-6 inline-flex items-center gap-2 rounded-full px-4 py-1.5 text-xs font-medium text-text-muted">
            <ServiceIcon name={service.icon} className="h-4 w-4 text-[var(--color-neon-blue)]" />
            Service
          </div>
          ...
          <div className="mt-9 flex flex-col gap-3.5 sm:flex-row">
            <a
              href={waLink(
                `Hi ${site.name}, I'd like to talk about ${service.title.toLowerCase()} for my business.`
              )}
              target="_blank"
